                         ...
                         <?php foreach ($va as $vv) 
                             { ?>
                              ...
                              <div class="caption">
                                ...
                                <p><a href="Dashboard/vente/<?php echo $vv->Id_produit ; ?>" clas="stbtn bn-success" role="button">sale</a> <a href="Dashboard/testapi"  class="btn btn-primary" role="button">See Details</a></p>
                            </div>
                        </div>
                              </div>
                          <?php  } ?>
